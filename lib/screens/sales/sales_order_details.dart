...
class SODetailPage extends StatefulWidget {
  ...
  @override
  State<SODetailPage> createState() => _SODetailPageState();
}

class _SODetailPageState extends State<SODetailPage> {
  ...
  @override
  void didUpdateWidget(covariant SODetailPage oldWidget) {
